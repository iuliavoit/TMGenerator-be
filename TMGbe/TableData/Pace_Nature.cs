...
public class PaceNature
{
    public List<ColumnBase> getTableColumnData()
    {
        ...
        Column<Component, int> medianCommitsColumn = new Column<Component, int>
            ("mediancommits", "median", "font-weight: 400;font-size: 13px;color: #6c757d;");
        ...
        Column<Component, int> medianRecentCommitsColumnTwo = new Column<Component, int>
            ("trendrecentcommits", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentMedianChumColumnTwo = new Column<Component, int>
            ("recentmedianchumtrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentMedianGrowthColumnTwo = new Column<Component, int>
            ("recentmediangrowthtrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentMedianFilesColumnTwo = new Column<Component, int>
            ("recentmedianfilestrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentMedianDevsColumnTwo = new Column<Component, int>
            ("recentmediandevstrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentMedianTasksColumnTwo = new Column<Component, int>
            ("recentmediantaskstrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentMedianDaysColumnTwo = new Column<Component, int>
            ("recentmediandaystrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentChangesCreationalColumnTwo = new Column<Component, int>
            ("recentchangescreationaltrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentChangesDevColumnTwo = new Column<Component, int>
            ("recentchangesdevtrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;",borderR:true);
        ...
        Column<Component, int> recentChangesRefColumnTwo = new Column<Component, int>
            ("recentchangesreftrend", "trend", "font-weight: 400;font-size: 13px;color: #6c757d;");
